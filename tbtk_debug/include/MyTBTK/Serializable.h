...
#ifndef COM_DAFER45_MyTBTK_SERIALIZABLE
#define COM_DAFER45_MyTBTK_SERIALIZABLE
...
inline std::string Serializable::serialize(const SpinMatrix &data, Mode mode){
	MyTBTKNotYetImplemented("Serializable::serialize<SpinMatrix>()");
}
...
inline SpinMatrix Serializable::deserialize(
	...
	MyTBTKNotYetImplemented("Serializable::deserialize<SpinMatrix>()");
}
	...
	case Mode::Debug:
	{
		...
		default:
			MyTBTKExit(
				...
				<< " a newer version of MyTBTK that supports"
