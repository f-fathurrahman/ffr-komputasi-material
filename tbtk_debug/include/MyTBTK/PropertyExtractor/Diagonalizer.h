...
#ifndef COM_DAFER45_MyTBTK_PROPERTY_EXTRACTOR_DIAGONALIZER
#define COM_DAFER45_MyTBTK_PROPERTY_EXTRACTOR_DIAGONALIZER
...
inline const Solver::Solver& Diagonalizer::getSolver() const{
	return solver;
}
