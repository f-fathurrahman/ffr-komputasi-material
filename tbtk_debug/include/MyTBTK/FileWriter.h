...
#ifndef COM_DAFER45_MyTBTK_FILE_WRITER
#define COM_DAFER45_MyTBTK_FILE_WRITER
...
/** Writes data to a .hdf5-file. The default file name is MyTBTKResults.h5. Can
...
public:
	...
	/** Set output file name. Default is MyTBTKResults.h5. */
