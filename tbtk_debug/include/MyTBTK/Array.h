...
#ifndef COM_DAFER45_MyTBTK_ARRAY
#define COM_DAFER45_MyTBTK_ARRAY

#include "MyTBTK/CArray.h"
 ...
 *
 *  *Note: If you write library code for MyTBTK, use IDX_ALL instead of \_a\_*.
 *
 *  # Example
...
public:
	//MyTBTKFeature Utilities.Array.construction.1 2019-10-31
	/** Constructor. */
	Array();

	//MyTBTKFeature Utilities.Array.construction.2 2019-10-31
	/** Constructor.
	 *
	 *  @param ranges The ranges of the Array. */
	explicit Array(const std::initializer_list<unsigned int> &ranges);

	//MyTBTKFeature Utilities.Array.construction.3 2019-10-31
	/** Constructor.
	 *
	 *  @param ranges The ranges of the Array.
	...
	//MyTBTKFeature Utilities.Array.operatorArraySubscript.1 2019-10-31
	...
	//MyTBTKFeature Utilities.Array.operatorArraySubscript.2 2019-10-31
	/** Array subscript operator.
	 *
	 *  @param index Index to get the value for.
	 *
	...
	//MyTBTKFeature Utilities.Array.operatorArraySubscript.3 2019-10-31
	...
	//MyTBTKFeature Utilities.Array.opreatorArraySubscript.4 2019-10-31
	/** Array subscript operator. Imediate access for optimization. For an
	 *  array with size {SIZE_A, SIZE_B, SIZE_C}, the supplied index should
	 *  be calculated as n = SIZE_C*SIZE_B*a + SIZE_C*b + c.
	 *
	...
	//MyTBTKFeature Utilities.Array.operatorAddition.1 2019-10-31
	//MyTBTKFeature Utilities.Array.operatorAddition.2 2019-10-31
	//MyTBTKFeature Utilities.Array.operatorAddition.3 2019-10-31
	/** Addition operator.
	 *
	...
	//MyTBTKFeature Utilities.Array.operatorSubtraction.1 2019-10-31
	//MyTBTKFeature Utilities.Array.operatorSubtraction.2 2019-10-31
	//MyTBTKFeature Utilities.Array.operatorSubtraction.3 2019-10-31
	...
	//MyTBTKFeature Utilities.Array.operatorMultiplication.1 2019-10-31
	...
	//MyTBTKFeature Utilities.Array.operatorMultiplication.2 2019-10-31
	/** Multiplication operator.
	 *
	...
	//MyTBTKFeature Utilities.Array.operatorDivision.1 2019-10-31
	/** Division operator.
	 *
	 *  @param rhs The right hand side of the expression.
	 *
	...
	//MyTBTKFeature Utilities.Array.getSlice.1
	...
	//MyTBTKFeature Utilities.Array.getData.1 2019-10-31
	...
	//MyTBTKFeature Utilities.Array.getData.2.C++ 2019-10-31
	/** Get raw data. If the array has ranges {SIZE_X, SIZE_Y, SIZE_Z},
	 *  rawData[SIZE_Z*(SIZE_Y*x + y) + z = array[{x, y, z}].
	 *
	 *  @return The raw data as a linear CArray. */
	...
	//MyTBTKFeature Utilities.Array.getSize.1 2019-10-31
