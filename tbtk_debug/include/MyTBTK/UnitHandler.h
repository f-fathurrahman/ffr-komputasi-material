...
#ifndef COM_DAFER45_MyTBTK_UNIT_HANDLER
#define COM_DAFER45_MyTBTK_UNIT_HANDLER
 ...
 *  MyTBTK does not enforce the use of a specific set of units. Instead it
 ...
 *
 *  In MyTBTK, all numbers are interpreted in terms of natural units. This means
 *  that MyTBTK assumes that any number passed to one of its functions is given
 ...
 *  just after MyTBTK has been initialized.
 *
 *  # Base units
 *  MyTBTK defines a number of base units for the six @link Quantity::Base Base
 ...
 *
 *  # Derived units
 *  In addition to the base units, MyTBTK also defines derived units for
...
>::type UnitHandler::convertArbitraryToBase(
	...
	return value*Quantity::getConversionFactor(
		getUnit<MyTBTK::Quantity::Angle>(),
		getUnit<MyTBTK::Quantity::Charge>(),
		getUnit<MyTBTK::Quantity::Count>(),
		getUnit<MyTBTK::Quantity::Energy>(),
		getUnit<MyTBTK::Quantity::Length>(),
		getUnit<MyTBTK::Quantity::Temperature>(),
		getUnit<MyTBTK::Quantity::Time>()
...
>::type UnitHandler::convertArbitraryToNatural(
	...
	result /= pow(
		getScale<MyTBTK::Quantity::Angle>(),
		Quantity::getExponent(MyTBTK::Quantity::Angle())
	);
	result /= pow(
		getScale<MyTBTK::Quantity::Charge>(),
		Quantity::getExponent(MyTBTK::Quantity::Charge())
	);
	result /= pow(
		getScale<MyTBTK::Quantity::Count>(),
		Quantity::getExponent(MyTBTK::Quantity::Count())
	);
	result /= pow(
		getScale<MyTBTK::Quantity::Energy>(),
		Quantity::getExponent(MyTBTK::Quantity::Energy())
	);
	result /= pow(
		getScale<MyTBTK::Quantity::Length>(),
		Quantity::getExponent(MyTBTK::Quantity::Length())
	);
	result /= pow(
		getScale<MyTBTK::Quantity::Temperature>(),
		Quantity::getExponent(MyTBTK::Quantity::Temperature())
	);
	result /= pow(
		getScale<MyTBTK::Quantity::Time>(),
		Quantity::getExponent(MyTBTK::Quantity::Time())
	);
