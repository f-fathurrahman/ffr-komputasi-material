...
#ifndef COM_DAFER45_MyTBTK_HOPPING_AMPLITUDE
#define COM_DAFER45_MyTBTK_HOPPING_AMPLITUDE
...
public:
	...
	//MyTBTKFeature Core.HoppingAmplitude.Construction.1 2019-09-23
	/** Constructs an uninitialized HoppingAmplitude. */
	HoppingAmplitude();

	//MyTBTKFeature Core.HoppingAmplitude.Construction.2 2019-09-23
	...
	//MyTBTKFeature Core.HoppingAmplitude.Construction.3 2019-09-23
	...
	//MyTBTKFeature Core.HoppingAmplitude.Copy.1 2019-09-23
	//MyTBTKFeature Core.HoppingAmplitude.Copy.2 2019-09-23
	/** Copy constructor.
	 *
	 *  @param ha HoppingAmplitude to copy. */
	HoppingAmplitude(const HoppingAmplitude &ha);

	//MyTBTKFeature Core.HoppingAmplitude.Serialization.1 2019-09-23
	...
	//MyTBTKFeature Core.HoppingAmplitude.getHermitianConjugate.1 2019-09-23
	//MyTBTKFeature Core.HoppingAmplitude.getHermitianConjugate.2 2019-09-23
	...
	//MyTBTKFeature Core.HoppingAmplitude.getAmplitude.1 2019-09-23
	//MyTBTKFeature Core.HoppingAmplitude.getAmplitude.2 2019-09-23
	/** Get the amplitude value \f$a_{ij}\f$.
	 *
	 *  @return The value of the amplitude. */
	std::complex<double> getAmplitude() const;

	//MyTBTKFeature Core.HoppingAmplitude.operatorAddition.1.C++ 2019-09-23
	...
	//MyTBTKFeature Core.HoppingAmplitude.getToIndex.1 2019-09-23
	/** Get to index.
	 *
	 *  @return The to-Index. */
	const Index& getToIndex() const;

	//MyTBTKFeature Core.HoppingAmplitude.getFromIndex.1 2019-09-23
	/** Get from index.
	 *
	 *  @return The from Index. */
	const Index& getFromIndex() const;

	//MyTBTKFeature Core.HoppingAmplitude.getIsCallbackDependent.1 2019-09-23
	//MyTBTKFeature Core.HoppingAmplitude.getIsCallbackDependent.2 2019-09-23
	...
	//MyTBTKFeature Core.HoppingAmplitude.getAmplitudeCallback.1 2019-09-23
	//MyTBTKFeature Core.HoppingAmplitude.getAmplitudeCallback.2 2019-09-23
