...
datadir_psp() = normpath(joinpath(pwd(), "my_dftk_data", "psp"))
#XXX ffr: This is not robust
#XXX ffr: This workaround is not yet working!!!
#XXX      Need to modify the logic of load_psp.
#XXX      For now, use full path.
