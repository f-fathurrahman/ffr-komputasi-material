...
_sumip(pot1, pot2) = JuLIP.MLIPs.SumIP([pot1, pot2])

_sumip(pot1::JuLIP.MLIPs.SumIP, pot2) = JuLIP.MLIPs.SumIP([pot1.components..., pot2])
...
function my_acefit!(
    ...
    # XXX Need to pass model.basis instead of model            
