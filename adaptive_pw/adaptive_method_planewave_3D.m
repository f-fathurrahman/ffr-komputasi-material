function [lambda, phi, err, Ecut, u] = adaptive_method_planewave_3D(L, Ec0, Neig, tol, MAX_Ec, MAX_iter)
...
V=@V_osc_3D;
 ...
 %(6) V=@V_lnr_3D;
 %(7) V=@V_gauss_3D;
    [lambda,phi,err_posto,dof,vec_k,H,M,vext,HV,u,weight] = eigen_planewave_3D(V,L, Ec, Neig, MAX_Ec);
