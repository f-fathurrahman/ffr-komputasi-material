...
from my_boltztrap2.misc import ffloat
from my_boltztrap2.sphere import calc_reciprocal_iksubset
...
def read_CASTEP_output(filename):
    ...
    # currently implemented in my_boltztrap2.
...
def read_GPAW(filename):
    ...
    atoms = calc.atoms
    fermi = calc.get_fermi_level() * my_boltztrap2.units.eV
    ...
    for i in range(nkpoints):
        ebands[i] = calc.get_eigenvalues(i) * my_boltztrap2.units.eV
