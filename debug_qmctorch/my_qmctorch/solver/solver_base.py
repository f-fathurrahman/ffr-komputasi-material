...
class SolverBase:
    ...
    def __init__(self, wf=None, sampler=None,
        ...
        Args:
            wf (my_qmctorch.WaveFunction, optional): wave function. Defaults to None.
            sampler (my_qmctorch.sampler, optional): Sampler. Defaults to None.
        ...
        if output is None:
            ...
            self.hdf5file = basename + '_MyQMCTorch.hdf5'
    ...
    def sampling_traj(self, pos=None, with_tqdm=True, hdf5_group='sampling_trajectory'):
        ...
        el = []
        rng = tqdm(p, desc='INFO:MyQMCTorch|  Energy  ',
