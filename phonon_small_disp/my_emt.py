...
# Important methods from NeighborList: update() and get_neighbors()
...
class MyEMT(Calculator):
    ...
    def initialize(self, atoms):
        ...
        self.nl = MyNeighborList([0.5 * self.rc_list] * len(atoms),
                               self_interaction=False)
        print("---------------------------")
        print("Finished initializing MyEMT")
        print("---------------------------")
