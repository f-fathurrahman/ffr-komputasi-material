...
import MyACE1.DAG: CorrEvalGraph, get_eval_graph, traverse_fwd!
...
write_dict(b::PIBasisFcn) =
   Dict("__id__" => "MyACE1_PIBasisFcn",
        "z0" => write_dict(b.z0),
        "oneps" => write_dict.(b.oneps))

read_dict(::Val{:MyACE1_PIBasisFcn}, D::Dict) =
...
==(B1::PIBasis, B2::PIBasis) = MyACE1.allfieldsequal(B1, B2)
...
MyACE1.get_basis_spec(basis::MyACE1.PIBasis, iz0::Integer) = 
     [ MyACE1.get_basis_spec(basis, iz0, i) for i = 1:length(basis.inner[iz0])  ]
