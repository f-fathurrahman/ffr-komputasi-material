...
# const MyACE1_VERSION_NUMBER = pkgversion(@__MODULE__())
...
include("polynomials/transforms.jl"); @reexport using MyACE1.Transforms
include("polynomials/orthpolys.jl"); @reexport using MyACE1.OrthPolys
include("polynomials/splines.jl"); @reexport using MyACE1.Splines
...
include("rpi/rpi.jl")
@reexport using MyACE1.RPI

# pair potentials + repulsion
include("pairpots/pair.jl");
@reexport using MyACE1.PairPotentials
...
#  ...
include("random.jl")
@reexport using MyACE1.Random


include("utils.jl")
@reexport using MyACE1.Utils
