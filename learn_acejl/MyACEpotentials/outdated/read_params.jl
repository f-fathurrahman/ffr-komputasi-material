...
# ------------------------------------------
#   Read MyACE fit parameters from file 
...
```julia 
    "fit_params" => MyACEpotentials.fit_params,
    "data" => MyACEpotentials.data_params,
    "solver" => MyACEpotentials.solver_params,
    "basis" => MyACEpotentials.basis_params,
    "ace" => MyACEpotentials.ace_basis_params,  
    "pair" => MyACEpotentials.pair_basis_params,
    "radial" => MyACEpotentials.radial_basis_params,
    "transform" => MyACEpotentials.transform_params, 
    "degree" => MyACEpotentials.degree_params,
    "P" => MyACEpotentials.regularizer_params
```
