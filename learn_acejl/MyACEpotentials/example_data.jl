...
# Meta-data for these datasets are stored in the MyACEdata  repository 
#   https://github.com/MyACEsuit/MyACEData
#
#
...
_example_data = Dict(
   "Si_tiny" => (  art = "Si_tiny_dataset", 
                 train = "Si_tiny.xyz", 
                  test = nothing, 
                  meta = "a tiny Si dataset used for unit tests" ), 
   "TiAl_tiny" => ( art = "TiAl_tiny_dataset", 
                  train = "TiAl_tiny.xyz", 
                   test = nothing, 
                   meta = "tiny version of the TiAl_tutorial dataset used for unit tests" ), 
   "TiAl_tutorial" => ( art = "TiAl_tutorial", 
                      train = "TiAl_tutorial.xyz", 
                       test = nothing, 
                       meta = "A TiAl dataset generated specifically for MyACEpotentials.jl tutorials" ),
     [ 
