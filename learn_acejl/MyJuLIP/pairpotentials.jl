...
# part of the module MyJuLIP.Potentials

using MyJuLIP: JVec, JMat, neighbourlist
...
write_dict(V::ZBLPotential) = Dict("__id__" => "MyJuLIP_ZBLPotential")
read_dict(::Val{:MyJuLIP_ZBLPotential}, D::Dict) = ZBLPotential()
