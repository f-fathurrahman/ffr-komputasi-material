...
# import MyJuLIP: energy, virial, site_energies, forces
# import MyJuLIP.Potentials: evaluate

import MyJuLIP.FIO: read_dict, write_dict
using MyJuLIP: JVec, JMat, chemical_symbols
...
read_dict(::Val{:MyJuLIP_OneBody}, D::Dict) = OneBody(D["E0"])
