...
using MyJuLIP.FIO: load_dict
using MyJuLIP: chemical_symbol, atomic_number
using MyJuLIP.Potentials: WrappedAnalyticFunction, F64fun, @D

import MyJuLIP.Potentials: evaluate!, evaluate_d!
...
how to implement a multi-component calculator in MyJuLIP
"""
