...
using MyJuLIP: AbstractAtoms, Dofs, maxdist,
...
using MyJuLIP.Potentials: @pot, @analytic, evaluate, evaluate_d, PairPotential, HS,
...
import MyJuLIP:             update!
import MyJuLIP.Potentials:  precon!, cutoff
import Base:              *, \, size
...
"""
`IPPrecon`: the standard preconditioner type for MyJuLIP
...
the type can overload `MyJuLIP.Preconditioners.update_inner!`.
