...
class TightBindingModel(object):
    ...
    def __init__(self,dim_k,dim_r,lat=None,orb=None,per=None,nspin=1):
        ...
        #
            ...
            raise Exception("\n\nArgument lat is not a list or ndarray.")
        #
        else:
        ...
        if per == None:
            ...
            print("First _dim_k=%d are treated as periodic." % self._dim_k)
...
matrix.""")            
    ...
    def cut_piece(self,num,fin_dir,glue_edgs=False):
        ...
        :returns:
          * **fin_model** -- Object of type
            :class:`pythtb.TightBindingModel` representing a cutout
        ...
        # generate object of TightBindingModel type that will correspond to a cutout
        fin_model=TightBindingModel(self._dim_k-1,
                           self._dim_r,
    ...
    def reduce_dim(self,remove_k,value_k):
        ...
        :returns:
          * **red_tb** -- Object of type :class:`pythtb.TightBindingModel`
    ...
    def make_supercell(self, sc_red_lat, return_sc_vectors=False, to_home=True):
        ...
        Returns tight-binding model :class:`pythtb.TightBindingModel`
        ...
        :returns:
          * **sc_tb** -- Object of type :class:`pythtb.TightBindingModel`
        ...
        # create super-cell TightBindingModel object to be returned
        sc_tb=TightBindingModel(self._dim_k,self._dim_r,sc_cart_lat,sc_orb,per=self._per,nspin=self._nspin)
    ...
    def remove_orb(self,to_remove):
        ...
        :returns:
          ...
          * **del_tb** -- Object of type :class:`pythtb.TightBindingModel` 
    ...
    def k_uniform_mesh(self,mesh_size):
        ...
        passed to function :func:`pythtb.TightBindingModel.solve_all`.  This
        ...
        :returns:
          ...
          * **k_vec** -- Array of k-vectors on the mesh that can be
            directly passed to function  :func:`pythtb.TightBindingModel.solve_all`.
...
class wf_array(object):
    ...
    :class:`pythtb.TightBindingModel` on a regular or non-regular grid
    ...
    *Parametric or irregular k-space grid grid*:
    ...
    :func:`pythtb.TightBindingModel.solve_one` or
    :func:`pythtb.TightBindingModel.solve_all` (in the latter case one
    ...
    :param model: Object of type :class:`pythtb.TightBindingModel` representing
    ...
    def impose_pbc(self,mesh_dir,k_dir):
        ...
        :param k_dir: Corresponding to the periodic k-vector direction
          in the Brillouin zone of the underlying *TightBindingModel*.  Since
        ...
        Example usage::
          ...
          # example, if the underlying TightBindingModel is two dimensional but
    ...
    def position_matrix(self, key, occ, dir):
        """Similar to :func:`pythtb.TightBindingModel.position_matrix`.  Only
    ...
    def position_expectation(self, key, occ, dir):
        """Similar to :func:`pythtb.TightBindingModel.position_expectation`.  Only
        difference is that states are now specified with key in the
        mesh *key* and indices of bands *occ*."""
        # check if model came from w90
        if self._model._assume_position_operator_diagonal==False:
    ...
    def position_hwf(self, key, occ, dir, hwf_evec=False, basis="bloch"):
        """Similar to :func:`pythtb.TightBindingModel.position_hwf`.  Only
        difference is that states are now specified with key in the
        mesh *key* and indices of bands *occ*."""
        # check if model came from w90
        if self._model._assume_position_operator_diagonal==False:
...
def k_path(kpts,nk,endpoint=True):
    r"""
      ...
      .. warning:: This function is here only for backwards compatibility 
        with version of pythtb prior to 1.7.0.  Please use related :func:`pythtb.TightBindingModel.k_path`
...
Warning:
  ...
  Note that this k_path function is a member of the TightBindingModel class.
...
class w90(object):
    ...
    *prefix*\_centres.dat) one needs to include the following flags in the win
    ...
    To create :class:`pythtb.TightBindingModel` object user needs to call
    ...
    def model(self,zero_energy=0.0,min_hopping_norm=None,max_distance=None,ignorable_imaginary_part=None):
        ...
        This function returns :class:`pythtb.TightBindingModel` object that can
        ...
        *projections* block or the *prefix*.nnkp file to see which
        ...
        :class:`pythtb.TightBindingModel` object are equal to the centers of
        ...
        :returns:
           * **tb** --  The object of type :class:`pythtb.TightBindingModel` that can be used to
        ...
        Example usage::
          ...
          # returns TightBindingModel with all hopping parameters
        ...
        tb=TightBindingModel(3,3,self.lat,self.red_cen)
...
----------------------------------------------------------------------
  ...
  function on your TightBindingModel object
