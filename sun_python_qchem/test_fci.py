...
from ch14.fci_v1 import merge_h1_eri
...
def test_fci_v1():
    from ch14.fci_v1 import compute_hc
    run_hc(compute_hc)

def test_fci_v2():
    from ch14.fci_v2 import compute_hc
    run_hc(compute_hc)

def test_fci_v3():
    from ch14.fci_v3 import compute_hc
    run_hc(compute_hc)

def test_fci_pipeline():
    from ch14.fci_pipeline import compute_hc
    run_hc(compute_hc)

def test_h_diag():
    from pyscf import fci
    from ch14.fci_v1 import make_hdiag
    np.random.seed(9)
    norb = 5
    nelec_a, nelec_b = (2, 2)
    h1 = np.random.rand(norb, norb)
...
def test_fci_solve():
    from pyscf import fci
    from ch14.fci_v1 import FCI_solve
    np.random.seed(9)
    norb = 5
    nelec_a, nelec_b = (2, 2)
    h1 = np.random.rand(norb, norb)
