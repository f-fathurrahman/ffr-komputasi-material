...
from ch12_analytical_integrals_v4_numba.basis import CGTO, gto_offsets
from ch12_analytical_integrals_v4_numba import coulomb_1e_MD, eri_MD, eri_OS, eri_rys
...
do_timing(test_coulomb_1e_MD)
do_timing(test_eri_MD)
do_timing(test_eri_OS)
do_timing(test_eri_rys)
