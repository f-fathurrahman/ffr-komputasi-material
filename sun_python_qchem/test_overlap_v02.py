...
from ch12_analytical_integrals_v2.basis import CGTO
import ch12_analytical_integrals_v2.overlap_MD as overlap_MD
import ch12_analytical_integrals_v2.overlap_OS as overlap_OS
import ch12_analytical_integrals_v2.overlap_quadrature as overlap_quadrature
...
def test_overlap_quadrature():
    basis = new_basis()
    assert abs(overlap_quadrature.overlap_matrix(basis).sum() - 27.282308953984028) < 1e-9
