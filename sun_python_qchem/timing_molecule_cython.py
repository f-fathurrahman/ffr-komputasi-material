...
from ch12_analytical_integrals_v4_cython.basis import Molecule, gto_offsets
from ch12_analytical_integrals_v4_cython import eri_MD, eri_OS, eri_rys
...
'''
# Smaller
#gtos = Molecule.from_xyz(H2).assign_basis({'H': '6-31G'})
