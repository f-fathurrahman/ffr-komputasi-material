...
#from ch12_analytical_integrals_v4_numba import overlap_MD
from ch12_analytical_integrals_v1 import kinetic
from ch12_analytical_integrals_v1 import overlap_MD

#from ch12_analytical_integrals_v1 import coulomb_1e_MD
from ch12_analytical_integrals_v4_numba import coulomb_1e_MD

from .diis import DIIS, _HashableVector
...
class RHF:
    ...
    def get_hcore_s(self):
        ...
        s = overlap_MD.overlap_matrix(self.gtos)
        #
        #t = overlap_MD.get_matrix(self.gtos, overlap_MD.primitive_kinetic)
        t = kinetic.get_T_matrix(self.gtos)
        #
