...
# %%
rdata = np.load("../DATASET/solubility.npz")
...
model.add(tf.keras.layers.Dense(128, activation="relu")) # 256
...
result = model.fit(train_data, validation_data=val_data, epochs=5, verbose=1)
