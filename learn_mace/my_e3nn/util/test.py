...
from my_e3nn.util.jit import compile, get_tracing_inputs, get_compile_mode, _MAKE_TRACING_INPUTS
...
try:
    # If pytest is available, define an my_e3nn pytest plugin
...
def random_irreps(
    ...
    ----------
        ...
        clean : bool, optional
            If ``True``, only ``o3.Irreps`` objects will be returned. If ``False`` (the default), ``my_e3nn.o3.Irreps``-like objects like strings and lists of tuples can be returned.
        allow_empty : bool, optional
            Whether to allow generating empty ``my_e3nn.o3.Irreps``.
    Returns
    -------
...
def equivariance_error(
    ...
    irreps_in : list of `my_e3nn.o3.Irreps` or `my_e3nn.o3.Irreps`
    ...
    irreps_out : list of `my_e3nn.o3.Irreps` or `my_e3nn.o3.Irreps`
...
def assert_normalized(
    ...
    See https://docs.my_e3nn.org/en/stable/guide/normalization.html for more information on the normalization scheme.
