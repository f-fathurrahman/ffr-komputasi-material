...
class MessagePassing(torch.nn.Module):
    ...
    irreps_node_hidden : `my_e3nn.o3.Irreps`
        representation of the hidden features

    irreps_node_output : `my_e3nn.o3.Irreps`
...
def test():
    ...
    from my_e3nn.util.test import assert_equivariant, assert_auto_jitable
