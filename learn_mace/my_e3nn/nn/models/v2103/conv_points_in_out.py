...
from my_e3nn.nn import FullyConnectedNet
...
class Convolution(torch.nn.Module):
    ...
    Parameters
    ----------
    irreps_node_input : `my_e3nn.o3.Irreps`
        representation of the input node features

    irreps_node_output : `my_e3nn.o3.Irreps` or None
        representation of the output node features

    irreps_node_attr_input : `my_e3nn.o3.Irreps`
        representation of the input node attributes

    irreps_node_attr_output : `my_e3nn.o3.Irreps`
