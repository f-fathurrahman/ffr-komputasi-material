...
from my_e3nn.math import soft_one_hot_linspace
from my_e3nn.nn import FullyConnectedNet, Gate, ExtractIr
from my_e3nn.o3 import TensorProduct, FullyConnectedTensorProduct
...
class Convolution(torch.nn.Module):
    ...
    irreps_node_attr : `my_e3nn.o3.Irreps`
        representation of the node attributes

    irreps_edge_attr : `my_e3nn.o3.Irreps`
        representation of the edge attributes

    irreps_out : `my_e3nn.o3.Irreps` or None
...
class Network(torch.nn.Module):
    ...
    Parameters
    ----------
    irreps_in : `my_e3nn.o3.Irreps` or None
        representation of the input features
        can be set to ``None`` if nodes don't have input features

    irreps_hidden : `my_e3nn.o3.Irreps`
        representation of the hidden features

    irreps_out : `my_e3nn.o3.Irreps`
        representation of the output features

    irreps_node_attr : `my_e3nn.o3.Irreps` or None
