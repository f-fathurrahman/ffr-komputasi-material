...
class FullyConnectedTensorProduct(TensorProduct):
    ...
    Parameters
    ----------
    irreps_in1 : `my_e3nn.o3.Irreps`
        representation of the first input

    irreps_in2 : `my_e3nn.o3.Irreps`
...
class ElementwiseTensorProduct(TensorProduct):
    ...
    filter_ir_out : iterator of `my_e3nn.o3.Irrep`, optional
        filter to select only specific `my_e3nn.o3.Irrep` of the output
