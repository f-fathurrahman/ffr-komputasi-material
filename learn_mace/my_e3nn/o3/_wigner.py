...
constants_filename = os.path.join(os.path.dirname(__file__), 'constants.pt')
print("constants_filename = ", constants_filename)
_Jd, _W3j_flat, _W3j_indices = torch.load(constants_filename, weights_only=False)
