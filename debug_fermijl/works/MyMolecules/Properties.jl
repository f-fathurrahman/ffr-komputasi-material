...
"""
    MyMolecules.nuclear_repulsion(A::Atom, B::Atom)
...
"""
    MyMolecules.nuclear_repulsion(atoms::Molecule)
...
"""
    MyMolecules.center_of_mass(atoms::Molecule)
...
"""
    MyMolecules.nuclear_dipole(atoms::Molecule, o = (0.0, 0.0, 0.0))
