"""
    MyMolecules.function parse_file(file::String; unit=:angstrom, F=Float64, I=Int16)
...
"""
    MyMolecules.function parse_string(molstring::String; unit=:angstrom, F=Float64, I=Int16)
