function coulumb_to_fock!(F, D, J, b1::BasisSet, b2::BasisSet)
    ...
    b3 = MyGaussianBasis.BasisSet("$(b1.name*b2.name)", atoms, basis)
    Nvals = MyGaussianBasis.num_basis.(b3.basis)

    #b3 = MyGaussianBasis.BasisSet(b1, b2)
    #Nvals = [MyGaussianBasis.Libcint.CINTcgtos_spheric(i-1, b3.lc_bas) for i = 1:b3.nshells]
        ...
        Threads.@spawn begin
            ...
            for μ in 1:b1.nshells          # Shell index μ
                ...
                for ν in μ:b1.nshells      # Shell index ν
                    ...
                    MyGaussianBasis.ERI_2e3c!(buf, b3, μ, ν, A)
