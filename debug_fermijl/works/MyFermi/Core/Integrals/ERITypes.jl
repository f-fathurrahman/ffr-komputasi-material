...
"""
    MyFermi.Integrals.AbstractDFERI
...
```julia
julia> jk = MyFermi.Integrals.JKFIT()
julia> ints = MyFermi.Integrals.IntegralHelper(eri_type=jk) 
```
