...
from torchani_units import sqrt_mhessian2invcm, sqrt_mhessian2milliev, mhessian2fconst
from torchani_nn import SpeciesEnergies
...
class EnergyShifter(torch.nn.Module):
    ...
    def __init__(self, self_energies, fit_intercept=False):
        ...
        print("Initializing EnergyShifter with self_energies = ", self_energies)
    ...
    def sae(self, species):
        ...
        print("energy_shiter.fit_intercept = ")
    ...
    def forward(self, species_energies: Tuple[Tensor, Tensor],
        ...
        print("Calling self_energies.forward")
