function [ combinedBasis, TOTAL_ALL_STATES, ...
  TOTAL_UP_STATES, TOTAL_DN_STATES, ...
  upStates, dnStates ] = generateBasis( NUM_SITES, NUM_UP, NUM_DN )

  do_it = (NUM_UP <= NUM_SITES) && (NUM_DN <= NUM_SITES);
  if ~do_it
