...
a concrete type and overload `MyJuLIP.Potentials.ad_evaluate`.
...
@pot P1
MyJuLIP.Potentials.ad_evaluate(pot::P1, R::Matrix{T}) where {T<:Real} =
...
# using MyJuLIP, MyJuLIP.Potentials
# using MyJuLIP.Potentials: evaluate_d
# JJ = MyJuLIP
# JPP = MyJuLIP.Preconditioners
#
