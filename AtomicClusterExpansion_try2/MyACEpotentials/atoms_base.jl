...
function linear_errors(data, model::MyACE1x.MyACE1Model; kwargs...)
    return linear_errors(data, MyACEmd.MyACEpotential(model.potential.components); kwargs...)
end


function MyACEmd.MyACEpotential(model::MyACE1x.MyACE1Model; kwargs...)
    return MyACEmd.MyACEpotential(model.potential.components; kwargs...)
end


function linear_errors(
    data, 
    model::MyACEmd.MyACEpotential; 
