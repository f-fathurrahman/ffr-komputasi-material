...
function laplacian_regularizer(basis::MyJuLIP.MLIPs.IPSuperBasis; rlap_scal)
    return Diagonal(vcat(MyACE1.scaling.(basis.BB, rlap_scal)...))
end

function generate_regularizer(basis::MyJuLIP.MLIPs.IPSuperBasis, params::Dict)
