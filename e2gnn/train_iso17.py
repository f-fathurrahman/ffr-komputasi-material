...
if __name__ == "__main__":
    ...
    model = E2GNN(hidden_channels=512, num_layers=4, num_rbf=128, cutoff=6.0, max_neighbors=20, use_pbc=False, otf_graph=True).to(device)
